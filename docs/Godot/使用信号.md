...
现在，我们将使用信号让上一课 ([监听玩家输入](监听玩家输入.md)) 中的 Godot 图标通过按下按钮来开始和停止移动。
...
为了给游戏添加按钮，我们将创建一个新场景，其中包含一个 [Button](https://docs.godotengine.org/en/stable/classes/class_button.html) 节点和我们在 [编写你的第一个脚本](编写你的第一个脚本.md) 一课中创建的 `sprite_2d.tscn` 场景。
