...
def _():
    ...
    return AutoTokenizer, mo, nn, torch
...
@app.cell
def _(embedding_layer, token_ids, tokens, torch):
    # 转换为 Tensor
...
@app.cell
def _(embedding_layer, tokenizer, torch):
    # 单独查询一个 Token 的嵌入
    test_text = "小红帽"
...
@app.cell
def _(embedding_layer, text, tokenizer, torch):
