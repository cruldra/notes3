...
@app.cell
def _(Tokenizer, decoders, models, pre_tokenizers):
...
@app.cell
def _(pre_tokenizers, tokenizer, trainers):
    # 2. 训练 Tokenizer
...
@app.cell
def _(PreTrainedTokenizerFast, os, output_dir, special_tokens):
...
@app.cell
def _(fast_tokenizer, output_dir):
    # 5. 保存完整的分词器
